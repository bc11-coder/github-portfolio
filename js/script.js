...
(function(){
	...
	const translations = {
		de: {
			...
			'stack.one': 'Programmiersprachen & Frameworks: Java (Spring Boot)', 'stack.two': 'Dart (Flutter)', 'stack.three': 'SQL', 'stack.four': 'HTML/CSS/JavaScript (Basics)',
			'stack.five': 'Backend & DevOps: REST-APIs, Spring Data JPA', 'stack.six': 'Docker, Git, GitHub, GitLab, Postman', 'stack.seven': 'PostgreSQL',
			'stack.eight': 'UI/UX & Design: Figma, Canva', 'stack.nine': 'IDEs: IntelliJ IDEA, VS Code, Android Studio, Eclipse', 'stack.ten': 'Tools & Methodik: MS Office, Zoom, Slack, Scrum',
